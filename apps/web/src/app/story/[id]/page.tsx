      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 py-4 gap-4 relative" style={{ maxWidth: 900, margin: "0 auto", width: "100%", zIndex: 1 }}>
        ...
        {numScenes > 0 ? (
          <>
            ...
            {/* ── Social sharing strip — always visible below audio controls ── */}
            <div className="w-full flex items-center justify-between gap-2 px-1">
              <span style={{ fontFamily: "'Nunito', sans-serif", fontSize: "0.72rem", fontWeight: 600, color: "rgba(255,255,255,0.25)", whiteSpace: "nowrap" }}>
                Share story
              </span>
              <div className="flex items-center gap-2">
                {/* WhatsApp */}
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl font-bold text-xs transition-all hover:scale-105 hover:brightness-110"
                  style={{ background: "#25D366", color: "#fff", fontFamily: "'Nunito', sans-serif" }}
                ...
                {/* Instagram — opens native share on mobile via Web Share API */}
                <button
                  onClick={handleShare}
                ...
                <button
                  onClick={copyLink}
                  className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl font-bold text-xs transition-all hover:scale-105"
                  style={{ background: "rgba(255,255,255,0.08)", color: shareCopied ? "var(--lf-teal)" : "rgba(255,255,255,0.55)", border: "1px solid rgba(255,255,255,0.12)", fontFamily: "'Nunito', sans-serif" }}
                  title="Copy link"
                >
                  {shareCopied ? <Check size={13} /> : "🔗"}
